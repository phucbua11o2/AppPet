...
public class checkoutController {
	...
	public String Checkout(ModelMap model, HttpSession session) {
		...
		try {
			mailer.send("khanhhatasudai@gmail.com", user.getEmail(), "Đặt hàng thành công",		
					"Cảm ơn bạn đã đặt hàng tại Website.Tổng số tiền bạn phải trả là: "+"$"+price+" .Món hàng của bạn đang được chuẩn bị. Chúng tôi sẽ liên hệ với bạn sớm nhất!. Chân thành cảm ơn quý khách.");
